...
public class BenchmarkBasicDecos {
  ...
  public void basicDecorator() throws FlumeSpecException, IOException,
    ...
    for (String d : decos) {
      FlumeBenchmarkHarness.doDecoBenchmark(d, FlumeBenchmarkHarness.varyMsgBytes);
      FlumeBenchmarkHarness.doDecoBenchmark(d, FlumeBenchmarkHarness.varyNumAttrs);
      FlumeBenchmarkHarness.doDecoBenchmark(d, FlumeBenchmarkHarness.varyValSize);
    }
  }
}
